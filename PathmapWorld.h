...
public:
	...
	PathmapWorld(const unsigned& width, const unsigned& height, const unsigned& length, const glm::vec3& origin = glm::vec3(0));
	PathmapWorld(const glm::vec3& grid, const glm::vec3& origin = glm::vec3(0));
